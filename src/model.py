...
class face_model(tf.keras.Model):
    ...
    def __init__(self, params):
        ...
        img_size = (params.image_height, params.image_width, 3)
        self.base_model = tf.keras.applications.InceptionV3(include_top=False, input_shape=img_size, weights='imagenet')
